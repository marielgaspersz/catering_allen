  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Catering Allens</a>
      </div>
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="index.php">Home</a></li>
          <li><a href="menu.php">Menu Catering</a></li>
      ...
      <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="item active">
            ...
            <div class="fill" style="background-image:url('<?php $url ?>assets/img/1.png');"></div>
          ...
          <div class="item">
            ...
            <div class="fill" style="background-image:url('<?php $url ?>assets/img/2.png');"></div>
            <div class="carousel-caption">
              <h2>Caption 2</h2>
            </div>
          </div>
  ...
  <div class="container" style="margin-top:20px;">
    <div class="row">
      <div class="col-md-3">
        ...
        <div class="col-md-16">
          <br />
          <img src="<?php echo $url . 'assets/img/1.png'; ?>" width="100%"><br><br>
          <img src="<?php echo $url . 'assets/img/2.png'; ?>" width="100%">
        </div>
      </div>